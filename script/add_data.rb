...
keywords = ["ruby", "javascript", "start-up", "startup", "python", "php", "web", "data", "entrepreneur", "java", "C", "hack", "social%20media", "online%20marketing", "user%20design", "ui", "ui/ux", "venture%20capital", "fundraising"]
